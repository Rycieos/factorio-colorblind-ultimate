...
-- Space Age
create_icon("bioflux", SpaceIconPath .. "bioflux.png")
create_icon("holmium-solution", SpaceIconPath .. "fluid/holmium-solution.png")
create_icon("lithium-plate", SpaceIconPath .. "lithium-plate.png")
create_icon("promethium-asteroid-chunk", SpaceIconPath .. "promethium-asteroid-chunk.png")
create_icon("tungsten-carbide", SpaceIconPath .. "tungsten-carbide.png")
