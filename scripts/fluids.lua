...
function overlay_fluid_barreling(fluid, proto)
  ...
  elseif setting == Options.text_overlay then
    overlay_icon(
      barrel,
      TextOverlays[proto.text_overlay],
      proto.text_overlay2 and TextOverlays[proto.text_overlay2]
    )
  else
    overlay_icon(
      barrel,
      Overlays[proto.icon_overlay],
      proto.icon_overlay2 and Overlays[proto.icon_overlay2]
    )
  end
